...
def lambda_handler(event, context):
    ...
    try:
        ...
        return _response(500, {"message": "Could not read job."})
    ...
    if status != "SUCCEEDED":
        return _response(409, {"message": "Result not ready.", "job_id": job_id, "status": status})
    ...
    try:
        ...
        return _response(500, {"message": "Could not create download URLs."})
